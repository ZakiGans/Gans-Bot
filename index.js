		...
		try {
			...
			break  
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 HENRY BOT 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*[ Henry BROADCAST ]*\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
              ...
              case 'Bangsat':
                   ...
                   break
               case 'Henry':
                   teks = `aku pacarnya eh, BOT nya Henry`
                   client.sendMessage(text)
                   break
               case 'Kontol':
                   teks = `gajelas kontol`
